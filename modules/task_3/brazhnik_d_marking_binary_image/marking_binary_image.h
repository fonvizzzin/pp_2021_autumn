...
#ifndef MODULES_TASK_3_BRAZHNIK_DMARKING_BINARY_IMAGE_MARKING_BINARY_IMAGE_H_
#define MODULES_TASK_3_BRAZHNIK_DMARKING_BINARY_IMAGE_MARKING_BINARY_IMAGE_H_

std::vector<int> generate_binary_image(int w, int h);

std::pair<std::vector<int>, std::pair<std::vector<int>, int>> step_first(const std::vector<int>& data, int w, int h, int startMarked = 0);
...
#endif  // MODULES_TASK_3_BRAZHNIK_DMARKING_BINARY_IMAGE_MARKING_BINARY_IMAGE_H_
